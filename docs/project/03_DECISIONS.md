...
- Konsekvens: `docs/design/prototypes/VIDDEL_STATUS_TO_AUDIOLOGIST_VISUAL_REVIEW_v0_1.md` styrer eventuell implementeringsbrief sammen med struktur- og copy-CBA. Produktkode, data, lagring og deling er fortsatt uendret.
...
- Konsekvens: `docs/project/VIDDEL_CONVERSATION_AREA_UX_COPY_CBA_v0_1.md` styrer videre visuell design og senere implementeringsbrief. Copy-reviewen ligger i VIS ved siden av strukturreferansen. UX-copy-porten er lukket. Prinsippene for tittelgenerering skal revideres når faktisk bruk gir et bedre erfaringsgrunnlag.
...
- Konsekvens: `docs/project/VIDDEL_CONVERSATION_AREA_LAYOUT_CBA_v0_2.md` erstatter v0.1 som styrende strukturgrunnlag. Den repo-native wireframen under `public/vis/raw/` er versjonert beslutningsgrunnlag og finnes i VIS-menyen under «Mønsterverifiseringer», men er ikke produksjonsmarkup. Neste port er UX-copy; farger, hover, radius, endelige tokens og implementering er fortsatt åpne.
