...
export const visPageContracts: Record<string, VisPageContract> = {
  ...
  "status-to-audiologist-pattern-v01": {
    ...
    type: "interactive-pattern-verification",
    status: "reference",
    purpose: "Klikkbart, godkjent struktur- og copygrunnlag for et brukerkontrollert statusutkast.",
    primaryTask: "beslutninger-qa",
    audience: ["Thomas", "Vibeke", "@navigator", "@rigger"],
    canonicalSource: "docs/project/VIDDEL_STATUS_TO_AUDIOLOGIST_LAYOUT_CBA_v0_1.md",
    lastReviewed: "2026-07-31",
    ownerRole: "Thomas",
    nextAction: "Neste port er en lett visuell kontroll mot eksisterende semantiske tokens; deling, data og produktkode er ikke besluttet.",
  },
  "raw-wireframes": {
    id: "raw-wireframes",
  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        secondaryLabel: "Struktur + copy CBA v0.1",
