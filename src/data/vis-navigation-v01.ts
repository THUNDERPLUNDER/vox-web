...
export const visPageContracts: Record<string, VisPageContract> = {
  ...
  "horselsforbundet-insight-conversation-v01": {
    id: "horselsforbundet-insight-conversation-v01",
    title: "Innsikt for Hørselsforbundet",
    type: "interactive-pattern-verification",
    status: "reference",
    purpose: "Godkjent syntetisk starteksempel og samtaleguide for validering med Hørselsforbundet.",
    primaryTask: "beslutninger-qa",
    audience: ["Thomas", "Vibeke", "@navigator", "@rigger"],
    canonicalSource: "docs/project/VIDDEL_HORSELSFORBUNDET_INSIGHT_STRUCTURE_CBA_v0_1.md",
    lastReviewed: "2026-08-05",
    ownerRole: "Thomas",
    nextAction: "Bruk starteksempelet i samtaler og før funn tilbake til #305 før neste port.",
  },
  "raw-wireframes": {
    id: "raw-wireframes",
...
export const visNavSections: VisNavSection[] = [
  ...
  },
  {
    ...
    items: [
      ...
      {
        id: "horselsforbundet-insight-conversation-v01",
        label: "Innsikt for Hørselsforbundet",
        href: "/vis/viddel-horselsforbundet-insight-conversation-v0_1",
        secondaryLabel: "Samtalegrunnlag CBA v0.1",
        pageContractId: "horselsforbundet-insight-conversation-v01",
      },
    ],
  },
  {
