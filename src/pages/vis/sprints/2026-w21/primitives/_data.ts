...
export const primitivePages: PrimitivePage[] = [
  ...
  },
  {
    ...
    completionNotes: [
      "Applied context page tests five card roles — review /primitives/cards/context/ before decision candidate.",
      "Confirm hub cards work as borderless grouped surfaces with hover lift — no internal CTA.",
      "Confirm article teaser layouts (A/B/C) feel editorial with whole-card click preferred.",
      "Confirm helper/info boxes use dashed border only and remain visibly static.",
      "Confirm AI bridge stays connected to editorial content.",
      "Confirm dark/identity surfaces remain sparse.",
      "Interaction states deferred to later pass after Cards decision.",
    ],
    roundIntro: "These are Round 1 variants, not historical iterations.",
    iterationsHeading: "Round 1 variants",
    completionHeading: "What remains before cards are ready",
    iterations: [
